    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-8">
        ...
        <div className="text-center mb-6 md:mb-8">
          ...
          <h2 className="text-lg md:text-2xl font-semibold text-blue-600 mb-3">Campus Navigation System</h2>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-4 md:p-6 mb-4 md:mb-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-lg md:text-xl font-bold text-gray-900">Where do you want to go?</h3>
          </div>
          ...
          {!showQR ? (
            <div className="space-y-3 md:space-y-4">
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 md:px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-base md:text-lg"
                >
              ...
              <button
                ...
                className={`w-full flex items-center justify-center gap-2 px-6 py-3 md:py-4 rounded-lg text-white font-semibold text-base md:text-lg transition-all ${
                  selectedLocation
            ...
            <div className="text-center space-y-4 md:space-y-6">
              ...
              {/* QR Code */}
              <div className="bg-white border-4 border-gray-200 rounded-xl p-4 md:p-8 inline-block shadow-lg">
                <img
                  src={qrCodeUrl}
                  alt="QR Code"
                  className="w-48 h-48 md:w-72 md:h-72 mx-auto"
                />
              </div>
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2 px-6 py-3 md:py-4 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-bold text-base md:text-lg transition-all shadow-lg w-full md:w-auto"
              >
              ...
              <p className="text-xs md:text-sm text-gray-500">
                📱 Scan QR code or tap the button above
              </p>

              <div className="flex flex-col sm:flex-row gap-2 justify-center">
                <button
                  onClick={resetQR}
                  className="px-5 py-2.5 bg-gray-600 hover:bg-gray-700 text-white rounded-lg font-semibold text-sm transition-all"
                >
                ...
                <a
                  ...
                  className="px-5 py-2.5 bg-green-600 hover:bg-green-700 text-white rounded-lg font-semibold text-sm transition-all text-center"
                >
                  Download QR Code
                </a>
              </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-4 md:p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg md:text-xl font-bold text-gray-900">Campus Map</h3>
            <div className="flex gap-1 bg-gray-100 rounded-lg p-1">
              ...
              >
                <Satellite className="w-3.5 h-3.5 md:w-4 md:h-4" />
                <span>Satellite</span>
              </button>
              <button
          ...
          <div className="rounded-xl overflow-hidden border-2 border-gray-100" style={{ height: 'min(500px, 60vw)' }}>
            <iframe
          ...
          <style>{`
            @media (min-width: 768px) {
              .campus-map-iframe-wrapper { height: 700px !important; }
            }
          `}</style>
        </div>
